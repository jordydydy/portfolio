...
export function CommandPalette() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-[15vh] px-4 font-mono">
      ...
      {/* Modal Dialog */}
      <div className="relative w-full max-w-lg overflow-hidden rounded border border-zinc-200 dark:border-zinc-850 bg-white dark:bg-zinc-950 shadow-2xl flex flex-col max-h-[400px]">
        {/* Input area */}
        <div className="flex items-center gap-2 border-b border-zinc-200 dark:border-zinc-900 px-4 py-3">
          ...
          <input
            ...
            className="w-full bg-transparent text-xs text-zinc-900 dark:text-zinc-100 outline-none placeholder:text-zinc-500"
            autoFocus
          />
        </div>
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-between gap-4 rounded px-3 py-2 text-left text-xs transition-colors cursor-pointer ${
                    isSelected 
                      ...
                      : "text-zinc-500 dark:text-zinc-450 hover:bg-zinc-100/50 dark:hover:bg-zinc-900/40"
                  }`}
                >
                  ...
                  <span className="text-[9px] text-zinc-400 uppercase tracking-widest bg-zinc-100 dark:bg-zinc-900 px-1.5 py-0.5 rounded border border-zinc-200 dark:border-zinc-800">
                    {item.category}
                  </span>
                </button>
              )
