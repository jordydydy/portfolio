                        ...
                        <div className="space-y-4">
                            <div className="flex gap-3">
                                ...
                                <div className="space-y-0.5">
                                    ...
                                    <a href="mailto:djordyfernando07@gmail.com" className="text-xs text-zinc-705 dark:text-zinc-300 hover:text-zinc-950 hover:dark:text-zinc-100 transition-colors">
