...
export const metadata: Metadata = {
  title: "Jordy | Fullstack Software Engineer Portfolio",
  description: "Explore Jordy's software engineering portfolio, showcasing web development projects, technical skills, and professional experience.",
};
